...
const SECTIONS: Section[] = [
  {
    title: "时间前面打个 ~",
    lead:
      "跟时间有关的——哪天、几点、多久一次——前面都要加一个 ~ 才算数。不加的照原样留在标题里，不会被排期。" +
      "~ 半角全角都认（中文输入法按 shift + ` 出来的那个也行）。",
    cards: [
      { text: "~下周三 去体检", note: "打了 ~，「下周三」才算日期" },
      { text: "下周三 去体检", note: "没打 ~，整句就只是一句话，不会排到哪天" },
      { text: "~周五下午3点 提交周报", note: "一个 ~ 管紧跟着它的一整串；中间空了格，就再打一个 ~" },
    ],
  },
  {
    title: "什么时候做",
    lead: "打上 ~ 之后，按平时的说法写，不限格式。「月底」「年底」这类会换算成具体日期。",
    cards: [
      ...
      { text: "~半年内 考驾照", note: "算到往后第六个月的月底：9 月里写，就是明年 3 月 31 日" },
      { text: "~春节前 买好车票", note: "元旦 / 春节 / 清明 / 五一 / 端午 / 中秋 / 国庆 / 圣诞，过了就算明年的" },
    ],
  },
  {
    title: "几点做",
    lead: "钟点同样要 ~。写了钟点会到点提醒；只写日期不提醒。",
    cards: [
      ...
      { text: "~明天 ~下午3点 面谈", note: "日期和钟点之间空了格，各打一个 ~" },
    ],
  },
  {
    title: "多重要",
  ...
  {
    title: "每隔多久做一次",
    lead: "重复的事写一次，前面同样要 ~。完成一条后，下一次自动排上。",
    cards: [
      { text: "~每周一 交周报", note: "「~每周一三五」这样连写也识别；「~每周末」按设置里的周末日算" },
      { text: "~每个工作日 看盘", note: "周一至周五" },
      { text: "~每月15号 还款", note: "当月没有这一天时落在月末" },
      { text: "~每个月末 交房租", note: "写「~每月底」也行；只写「~每周」「~每个月」，就按那天是周几、几号" },
      { text: "~每3天 浇花", note: "每天 / 每N天" },
    ],
  },
  {
    title: "子任务也这么写",
    lead: "子任务同样识别日期、钟点和重要性，规矩一样：时间前面打 ~。清单、需求方、标签属于整件事，写在子任务里只当普通文字。",
    cards: [
    ...
    <div className="gd-body">
      ...
      <div className="gd-section">
        ...
        <p className="gd-lead">
          ...
          日期、钟点、重复在这句话里也各带一个 ~，删掉 ~ 那一段就是「不定日期」。
          旁边的 ↺ 放弃当前编辑，退回这件事现在的样子。
          <br />
          少数任务写不成完整一句话（标题里正好有 ~ 带着一个时间词，或者清单名带空格）。
